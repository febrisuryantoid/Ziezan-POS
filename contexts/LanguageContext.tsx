...
const dictionary = {
  id: {
    ...
    deactivate_confirm: "Konfirmasi Nonaktifkan",
    deactivate_member_msg: "Member akan disembunyikan & datanya diarsipkan. Anda bisa mengaktifkannya kembali nanti.",
  ...
  en: {
    ...
    deactivate_confirm: "Deactivation Confirmation",
    deactivate_member_msg: "The member will be hidden & their data archived. You can reactivate them later.",
