  ...
  return (
    ...
    >
      ...
      >
          ...
          {/* NEW: Animated Tier Border Wrapper */}
          <div
              className="relative w-full h-full rounded-[27px] p-[2px] animate-spin-border"
              style={{
          ...
          >
              {/* Card (Content) - Now nested inside the border wrapper */}
              <div className={`relative h-full w-full rounded-[25px] overflow-hidden bg-[#0D0D15]/80 backdrop-blur-2xl flex flex-col shadow-2xl card-inner shimmer-surface`}>
                  
                  {/* Tier-specific background tint */}
                  <div className={`absolute inset-0 ${theme.bg_tint} opacity-60`}></div>
                  
                  {/* DragonIcon as tier-colored watermark */}
                  ...
                  {/* Holographic Glare Effect (Mouse-based) */}
                  <div 
